...
void SFSConnector::InitializeSmartFox()
{
	...
	// Add event listeners
	mSmartFox->AddEventListener(SFSEvent::CONNECTION, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::CONNECTION_LOST, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::LOGIN, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::LOGIN_ERROR, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::LOGOUT, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::ROOM_JOIN, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::ROOM_JOIN_ERROR, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::USER_ENTER_ROOM, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::USER_EXIT_ROOM, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::EXTENSION_RESPONSE, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::PUBLIC_MESSAGE, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
	mSmartFox->AddEventListener(SFSEvent::PING_PONG, boost::shared_ptr<EventListenerDelegate>(new EventListenerDelegate(SFSConnector::OnSmartFoxEvent, (unsigned long long)this)));
...
void SFSConnector::OnSmartFoxEvent(unsigned long long ptrContext, boost::shared_ptr<BaseEvent> ptrEvent)
{
	SFSGEvent::getSingleton().OnSFSEvent(ptrContext, ptrEvent);
}
