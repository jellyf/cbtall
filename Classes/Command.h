...
namespace cmd
{
	...
	__DECLARE_CMD_PROPERTY(RANK_WIN, "715");
	__DECLARE_CMD_PROPERTY(PAYMENT, "716");
	__DECLARE_CMD_PROPERTY(PAYMENT_ENABLE, "778");
	__DECLARE_CMD_PROPERTY(COFFER_MONEY, "777");
	__DECLARE_CMD_PROPERTY(COFFER_HISTORY, "717");
	__DECLARE_CMD_PROPERTY(CURRENT_TABLE_RECONNECT, "61");
	__DECLARE_CMD_PROPERTY(VERIFY_FB_INVITE, "800");
	__DECLARE_CMD_PROPERTY(POPUP_EVENT, "801");
	__DECLARE_CMD_PROPERTY(CANCEL_ITEM_SHOP, "802");
	__DECLARE_CMD_PROPERTY(CHANGE_PASSWORD, "803");
	__DECLARE_CMD_PROPERTY(CHANGE_DISPLAYNAME, "804");
	__DECLARE_CMD_PROPERTY(TOUR_INFO, "806");
	__DECLARE_CMD_PROPERTY(TOP_TOUR_PLAYER, "46");
	__DECLARE_CMD_PROPERTY(LIST_TOUR_PLAYER, "461");
	__DECLARE_CMD_PROPERTY(REGISTER_TOUR, "88");
	__DECLARE_CMD_PROPERTY(TOUR_ROOM_TO_JOIN, "kk");
	__DECLARE_CMD_PROPERTY(RESPONSE_REGISTER_TOUR, "807");
	__DECLARE_CMD_PROPERTY(TOUR_NEW_ROUND, "xxx");
	__DECLARE_CMD_PROPERTY(TOUR_WINNERS, "462");
	__DECLARE_CMD_PROPERTY(TOUR_ROOM_MATCH, "197");
	__DECLARE_CMD_PROPERTY(TOUR_TIME_WAIT_PLAYER, "463");
	__DECLARE_CMD_PROPERTY(TOUR_LEAVE_TABLE, "42");
	__DECLARE_CMD_PROPERTY(KEEP_CONNECTION, "55");

	__DECLARE_CMD_PROPERTY(GAME_KICK_PLAYER, "35");
    ...
    __DECLARE_CMD_PROPERTY(GAME_REQUEST_DROP_PENET, "113");
