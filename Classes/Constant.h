...
namespace constant
{
	...
	__DECLARE_STRING_PROPERTY(STORE_APPLE, "itms-apps://itunes.apple.com/app/id");
	__DECLARE_STRING_PROPERTY(STORE_GOOGLE, "market://details?id=");
	...
	__DECLARE_STRING_PROPERTY(DISCONNECTION_REASON_SYNC, "sync");
	...
	__DECLARE_STRING_PROPERTY(KEY_RECONNECT_TIME, "KEY_RECONNECT_TIME_");
	__DECLARE_STRING_PROPERTY(KEY_RECONNECT_ZONE_INDEX, "KEY_RECONNECT_ZONE_INDEX_");
	//__DECLARE_STRING_PROPERTY(KEY_MONEY_TYPE, "KEY_MONEY_TYPE");

	__DECLARE_INT_PROPERTY(ZORDER_WEBVIEW, 1000);
	__DECLARE_INT_PROPERTY(ZORDER_POPUP, 500);
	__DECLARE_INT_PROPERTY(ZORDER_COFFER, 700);
	...
	__DECLARE_INT_PROPERTY(GAME_ZORDER_CARD_FLY, 110);
	...
	__DECLARE_INT_PROPERTY(GAME_ACTION_NONE, -1);
	...
	__DECLARE_INT_PROPERTY(TAG_HTTP_GAME_CONFIG, 1);
	__DECLARE_INT_PROPERTY(TAG_HTTP_COFFER_GUIDE, 2);
	__DECLARE_INT_PROPERTY(TAG_HTTP_LOG, 3);
	__DECLARE_INT_PROPERTY(TAG_HTTP_VILANG, 4);
	__DECLARE_INT_PROPERTY(TAG_HTTP_MENU1, 5);
	__DECLARE_INT_PROPERTY(TAG_HTTP_MENU2, 6);
	__DECLARE_INT_PROPERTY(TAG_HTTP_TOUR_GUIDE, 7);
	__DECLARE_INT_PROPERTY(TAG_HTTP_HU_PARTICLE, 100);
	...
	__DECLARE_INT_PROPERTY(ERR_JOIN_TOUR, 37);
}